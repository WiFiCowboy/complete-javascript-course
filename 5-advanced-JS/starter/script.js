...
var Movies = function(title, genere, rating) {
    this.title = title;
    this.genere = genere;
    this.rating = rating;
}

Movies.prototype.lead = 'Neo';
Movies.prototype.metaScore = function() {
    console.log(this.rating + 10);
     
};

var matrix = new Movies('The Matrix', 'Sci-Fi', 100);

matrix.metaScore();
console.log(matrix);
console.log(matrix.lead);
*/
